# Messaging Support Validation

Verify the message composition workflow, NPA messaging helpers (Intel/Screenshot buttons), and autocomplete functionality.

Documentation target: `Messaging support`
